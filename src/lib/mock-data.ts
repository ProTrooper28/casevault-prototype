...
export const CASES: Case[] = [
  {
    ...
    status: "Active",
    type: "Theft",
    investigator: "Insp. Meera Kulkarni",
    ...
    officers: [
      { name: "Insp. Meera Kulkarni", role: "Police Investigator", unit: "Andheri Police Station" },
      { name: "Dr. A. Banerjee", role: "Forensic Officer", unit: "Regional Forensic Lab" },
      { name: "Adv. N. Iyer", role: "Legal Officer", unit: "Prosecution Cell" },
    ],
  },
  {
    id: "CASE-2026-00418",
    ...
    officers: [
      { name: "Insp. Arjun Verma", role: "Police Investigator", unit: "Economic Offences Wing" },
      { name: "Adv. S. Kapoor", role: "Prosecutor", unit: "District Court, New Delhi" },
    ],
  },
  {
    id: "CASE-2026-00731",
    ...
    officers: [
      { name: "SI Kabita Das", role: "Police Investigator", unit: "Fancy Bazaar Police Station" },
...
export const DOCUMENTS: Document[] = [
  ...
  },
  {
    ...
    caseId: "FIR-2026-00124",
    uploadedBy: "Insp. Meera Kulkarni",
    date: "13 Jan 2026",
    version: "1.2",
    integrity: "verified",
    access: "Restricted",
...
export const EVIDENCE: Evidence[] = [
  {
    ...
    submittedBy: "Insp. Meera Kulkarni",
    date: "13 Jan 2026",
    integrity: "verified",
